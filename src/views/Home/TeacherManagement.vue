  ...
  <div class="page">
    <div class="content">
      ...
      <el-table :data="list.data" border v-loading="list.loading">
        <el-table-column prop="t_name" label="教师名称"></el-table-column>
       <el-table-column prop="t_id" label="教师工号"></el-table-column>
       <el-table-column label="性别">
          <template slot-scope="scope">
            <span v-if="scope.row.t_sex === 1">男</span>
            <span v-else-if="scope.row.t_sex === 2">女</span>
          </template>
       </el-table-column>
